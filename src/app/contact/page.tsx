          ...
          <div className="bg-[#fafafa] rounded-lg p-8 shadow-sm">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              ...
              <div className="flex justify-center space-x-4">
                <a href="#" className="w-8 h-8 rounded-full border border-[#8a63d2]/30 flex items-center justify-center text-[#6642c8] hover:bg-[#8a63d2]/10 transition-colors duration-300">
