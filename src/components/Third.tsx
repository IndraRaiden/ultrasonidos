    ...
    <section className="py-24 bg-[#070710]">
      <div className="container-custom">
        <div className="text-center mb-16">
          <span className="text-xs uppercase tracking-[0.2em] text-[#d4af37]/70 mb-4 block">Servicios Exclusivos</span>
          <h2 className="section-heading centered text-3xl">Nuestros Servicios</h2>
          <p className="text-gray-300 mt-8 max-w-2xl mx-auto font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="product-card group">
            <div className="aspect-[4/3] bg-[#0c0c14] relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-[#9d4eff]/10 to-transparent opacity-30"></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 rounded-full bg-[#070710] border border-[#d4af37]/20 flex items-center justify-center">
            ...
            <div className="product-info">
              <h3 className="text-lg font-light tracking-wider mb-3 text-white group-hover:text-[#d4af37] transition-colors duration-300">Diagnóstico por Ultrasonido</h3>
          ...
          <div className="product-card group">
            ...
            <div className="product-info">
              <h3 className="text-lg font-light tracking-wider mb-3 text-white group-hover:text-[#d4af37] transition-colors duration-300">Consultoría Industrial</h3>
              <p className="text-gray-400 mb-6 text-sm font-light">
          ...
          <div className="product-card group">
            ...
            <div className="product-info">
              <h3 className="text-lg font-light tracking-wider mb-3 text-white group-hover:text-[#d4af37] transition-colors duration-300">Mantenimiento Premium</h3>
              <p className="text-gray-400 mb-6 text-sm font-light">
